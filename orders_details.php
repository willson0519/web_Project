...
<head>
  ...
  <title>Sleep Beauty : Orders Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a161060, tbl_stafffs_a161060_pt2,
          tbl_customers_a161060_pt2 WHERE
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['Product_ID']; ?>" required><?php echo $productrow['Brand']." ".$productrow['Product_Name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
...
<script type="text/javascript">
  ...
  function validateForm() {
      ...
      var x = document.forms["oid"]["pid"].value;
      var y = document.forms["oid"]["quantity"].value;
      var x = document.getElementById("prd").value;
      var y = document.getElementById("qty").value;
      if (x == null || x == "") {
          alert("Product must be selected");
          document.forms["oid"]["pid"].focus();
          document.getElementById("prd").focus();
          return false;
      }
      if (y == null || y == "") {
          alert("Quantity must be filled out");
          document.forms["oid"]["quantity"].focus();
